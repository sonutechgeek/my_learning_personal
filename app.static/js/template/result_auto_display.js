  ...
  $(document).keydown(function (e) {
    ...
    if (keyCode == 112 && cookies.toUpperCase() == 'FALSE') {
      ...
      if (checkresult == 'ONEBYONERESULT') {
        ...
        //                    alert(oneallimgname);
        testArray = "img/fullscreen_img/last_sevendaysonebyone/" + oneallimgname + "_" + oneleftsrno + ".png"  in oneallimagenamearr;
        if (testArray == true) {
        ...
        testArray = "img/fullscreen_img/last_sevenday/" + allimgname + "_" + leftsrno + ".png"  in allimagenamearr;
        if (testArray == true) {
          ...
          if (flag1 == true) {
            ...
            html2canvas($('#message_' + sn), {
              ...
              onrendered: function (canvas) {
                ...
                //                                alert(imgageData);
                $.post("app.result/classes/SaveSevenImages.php?" + Math.random(), {flag: "SAVE", imgName: "../img/fullscreen_img/last_sevenday/" + divdata[1] + "_" + imgno++ + ".png", imgBase64: imgageData}).then(function (response) {
                  //                                alert(response);
                  //                                exit;
          ...
          if (flag1 == true) {
            ...
            html2canvas($('#message_' + sn), {
              ...
              onrendered: function (canvas) {
                ...
                imgageData = getCanvas.toDataURL("image/png");
                //                                alert(imgageData);
                $.post("app.result/classes/SaveSevenDaysOneByOneImages.php?" + Math.random(), {flag: "SAVE", imgName: "../img/fullscreen_img/last_sevendaysonebyone/" + divdata[1] + "_" + imgno++ + ".png", imgBase64: imgageData}).then(function (response) {
                  //                                alert(response);
                  //                                exit;
                  if (response.includes("#ERROR:")) {
                    alert("No Images attached to this survey.")
...
function leftRightSide(leftsrno) {
  ...
  //        clearInterval(intervalvar);
  //        clearInterval(changereslt_var);
  var testArray1 = "img/fullscreen_img/last_sevenday/" + allimgname + "_" + leftsrno + ".png"  in allimagenamearr;
  //        alert(testArray);
  if (testArray1 == true) {
...
function leftRightOneByOneSide(leftsrno) {
  ...
  //        clearInterval(intervalvar);
  //        clearInterval(changereslt_var);
  var testArray1 = "img/fullscreen_img/last_sevendaysonebyone/" + oneallimgname + "_" + leftsrno + ".png"  in oneallimagenamearr;
  //        alert(testArray);
  if (testArray1 == true) {
      ...
      if (html.toUpperCase().indexOf("#EXISTS:") !== -1) {
        ...
        html2canvas($('#message'), {
          onrendered: function (canvas) {
            ...
            imgageData = getCanvas.toDataURL("image/png");
            //                        aler  t(imgageData);
            $.post("app.result/classes/SaveImages.php?" + Math.random(), {flag: "SAVE", imgBase64: imgageData, imgName: "../img/fullscreen_img/" + img_nametwo + ".png"}).then(function (response) {
              if (response.includes("#ERROR:")) {
                alert("No Images attached to this survey.")
              } else {
...
//                                    alert(imgageData);
//            alert("1");
            $.post("app.result/classes/SaveImages.php?" + Math.random(), {flag: "SAVE_ONE_RESULT", imgBase64: imgageData, imgName: "../img/fullscreen_img/" + img_name + ".png"}).then(function (response) {
                                              alert(response);
              if (response.includes("#ERROR:")) {
                alert("No Images attached to this survey.")
              } else {
